...
class PluginFieldsComputerinsertionintheformInjection extends PluginFieldsComputerinsertionintheform implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Computer::getTypeName() . " - Insertion in the form";
   }
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('Computer', 1);
