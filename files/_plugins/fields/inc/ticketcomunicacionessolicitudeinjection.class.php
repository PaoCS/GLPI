...
class PluginFieldsTicketcomunicacionessolicitudeInjection extends PluginFieldsTicketcomunicacionessolicitude implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Ticket::getTypeName() . " - Comunicaciones-Solicitudes";
   }
