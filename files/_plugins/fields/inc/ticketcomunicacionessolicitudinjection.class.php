...
class PluginFieldsTicketcomunicacionessolicitudInjection extends PluginFieldsTicketcomunicacionessolicitud implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Ticket::getTypeName() . " - Comunicaciones-Solicitud";
   }
