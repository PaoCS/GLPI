...
class PluginFieldsPruebafieldDropdown extends CommonTreeDropdown {
   public $field_name      = "pruebafield";
   ...
   static function install() {
      ...
      if (!$DB->tableExists($table)) {
         $query = "CREATE TABLE IF NOT EXISTS `$table` (
                  ...
                  `plugin_fields_pruebafielddropdowns_id` INT(11)        DEFAULT NULL,
                  ...
                  KEY                                       `plugin_fields_pruebafielddropdowns_id`
                                                            (`plugin_fields_pruebafielddropdowns_id`)
